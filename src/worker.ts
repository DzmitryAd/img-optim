import { parsePath, changeExt, createSarchParams, arePropsAllowed, TEnv } from "./api-common"
...
const widths: number[] = [1170, 970, 750, 320]
const heights: number[] = []

const handle = async (event: FetchEvent) => {
  const env: TEnv = { API_GATEWAY_URL, FORMATED_IMG_URL_PREFIX, ORIGIN_IMG_URL_PREFIX }
